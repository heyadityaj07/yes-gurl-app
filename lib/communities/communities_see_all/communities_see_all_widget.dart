  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (FFAppState().sharedEvent?.id != null &&
        ...
        logFirebaseEvent('communitiesSeeAll_update_page_state');
        _model.sharedEvent = _model.sharedEventRead;
        safeSetState(() {});
      }
      logFirebaseEvent('communitiesSeeAll_request_permissions');
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                onChanged: (_) =>
                                                  ...
                                                  () async {
                                                    logFirebaseEvent(
                                                        'COMMUNITIES_SEE_ALL_SearchRequestUser_ON');
                                                    logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        errorBuilder: (context,
                                                                          ...
                                                                          width:
                                                                              100.0,
                                                                          height:
                                                                              MediaQuery.sizeOf(context).height * 0.111,
                                                                          fit: BoxFit
                                                                              .cover,
                                                                        ),
                                                                        memCacheWidth:
