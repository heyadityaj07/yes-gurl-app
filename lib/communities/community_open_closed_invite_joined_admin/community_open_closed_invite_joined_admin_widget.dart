...
import 'community_open_closed_invite_joined_admin_model.dart';
export 'community_open_closed_invite_joined_admin_model.dart';

class CommunityOpenClosedInviteJoinedAdminWidget extends StatefulWidget {
  const CommunityOpenClosedInviteJoinedAdminWidget({
    super.key,
  ...
  static String routeName = 'communityOpenClosedInviteJoinedAdmin';
  static String routePath = '/communityOpenClosedInviteJoinedAdmin';

  @override
  State<CommunityOpenClosedInviteJoinedAdminWidget> createState() =>
      _CommunityOpenClosedInviteJoinedAdminWidgetState();
}

class _CommunityOpenClosedInviteJoinedAdminWidgetState
    extends State<CommunityOpenClosedInviteJoinedAdminWidget>
    with TickerProviderStateMixin {
  late CommunityOpenClosedInviteJoinedAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CommunityOpenClosedInviteJoinedAdminModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'communityOpenClosedInviteJoinedAdmin'});
    ...
    _model.leaveComponentFocusNode!.addListener(
      () async {
        logFirebaseEvent('COMMUNITY_OPEN_CLOSED_INVITE_JOINED_ADMI');
                                      ...
                                      Align(
                                        ...
                                        child: Builder(
                                          builder: (context) =>
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'COMMUNITY_OPEN_CLOSED_INVITE_JOINED_ADMI');
                                              logFirebaseEvent(
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (_model.leaveComponentTextController
                                                  ...
                                                  triggerPushNotification(
                                                    ...
                                                    initialPageName:
                                                        'communityOpenClosedInviteJoinedAdmin',
                                                    parameterData: {
                                                      'eventRef':
                                                          widget!.eventRef,
                                                    },
