...
import 'community_open_model.dart';
export 'community_open_model.dart';

class CommunityOpenWidget extends StatefulWidget {
  const CommunityOpenWidget({
    super.key,
  ...
  static String routeName = 'communityOpen';
  static String routePath = '/communityOpen';

  @override
  State<CommunityOpenWidget> createState() => _CommunityOpenWidgetState();
}

class _CommunityOpenWidgetState extends State<CommunityOpenWidget>
    with TickerProviderStateMixin {
  late CommunityOpenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommunityOpenModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'communityOpen'});
    ...
    _model.leaveComponentFocusNode!.addListener(
      () async {
        logFirebaseEvent('COMMUNITY_OPEN_leaveComponent_ON_FOCUS_C');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('COMMUNITY_OPEN_arrow_back_ios_rounded_IC');
                                ...
                                Align(
                                  ...
                                  child: Builder(
                                    builder: (context) => FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'COMMUNITY_OPEN_more_vert_rounded_ICN_ON_');
                                        logFirebaseEvent(
                                        ...
                                        if (_model.dialoguereturn == 'report') {
                                          logFirebaseEvent(
                                              'IconButton_alert_dialog');
                                          await showDialog(
                                            context: context,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'COMMUNITY_OPEN_PAGE_Text_kmminop9_ON_TAP');
                                              ...
                                              child: Builder(
                                                builder: (context) => Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'COMMUNITY_OPEN_Image_m9wu0yyy_ON_TAP');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            onChanged: (_) =>
                                              ...
                                              () async {
                                                logFirebaseEvent(
                                                    'COMMUNITY_OPEN_leaveComponent_ON_TEXTFIE');
                                                logFirebaseEvent(
                                        ...
                                        FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'COMMUNITY_OPEN_PAGE_send_ICN_ON_TAP');
                                            ...
                                            if (_model.leaveComponentTextController
                                              ...
                                              while (_model.commentIndex <
                                                ...
                                                if (_model.users!
                                                  ...
                                                  _shouldSetState = true;
                                                  if (functions.managedatetimefunction(
                                                          _model
                                                                  ...
                                                                  Builder(
                                                                    builder:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'COMMUNITY_OPEN_Container_ghdax2jl_ON_TAP');
                                                                        if (containerUserRecord!
                                                                            .isDeactivated) {
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder: (context) =>
                                                                              ...
                                                                              child: InkWell(
                                                                                ...
                                                                                highlightColor: Colors.transparent,
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('COMMUNITY_OPEN_Image_n5rhtw13_ON_TAP');
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('COMMUNITY_OPEN_more_vert_rounded_ICN_ON_');
              ...
              Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'COMMUNITY_OPEN_PAGE_DELETE_BTN_ON_TAP');
                        ...
                        if (!widget!.eventRef!.attending
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'COMMUNITY_OPEN_PAGE_JOIN_BTN_ON_TAP');
                        ...
                        if (widget!.eventRef!.attending
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'COMMUNITY_OPEN_PAGE_LEAVE_BTN_ON_TAP');
                                logFirebaseEvent('Button_backend_call');
                  ...
                  if (widget!.eventRef?.role == 'admin')
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'COMMUNITY_OPEN_GET_TICKETS_BTN_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('COMMUNITY_OPEN_PAGE_JOIN_BTN_ON_TAP');
                        logFirebaseEvent('Button_launch_u_r_l');
