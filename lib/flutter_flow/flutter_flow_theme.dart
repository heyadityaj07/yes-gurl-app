...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFE99AB);
  late Color secondary = const Color(0xFFF2D7D7);
  late Color tertiary = const Color(0xFFFDF7F8);
  ...
  late Color accent2 = const Color(0xFFDC6874);
  late Color accent3 = const Color(0xFFF2D7D7);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0x8E57636C);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE0778B);
  late Color secondary = const Color(0xFF90656C);
  late Color tertiary = const Color(0xFF24191C);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFF0F2F5);
  late Color primaryBackground = const Color(0xFF1D2428);
  late Color secondaryBackground = const Color(0xFF14181B);
  late Color accent1 = const Color(0xFFFFFFFF);
  late Color accent2 = const Color(0xFFDC6874);
  late Color accent3 = const Color(0xFFE0778B);
  late Color accent4 = const Color(0xB2262D34);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFF7A7A7A);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
