                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'LOGIN_EMAIL_RichText_7jwwe8dt_ON_TAP');
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (valueOrDefault<bool>(
                                      ...
                                      context.goNamedAuth(
                                          ...
                                          context.mounted);
                                    } else if (_model.userdocument?.banned ==
                                        false) {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Admin, your account has been suspended for security reasons',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .secondaryBackground,
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'LOGIN_EMAIL_RichText_u88uv0df_ON_TAP');
                          logFirebaseEvent('RichText_navigate_to');

                          context.pushNamed(LoginEmailSignUpWidget.routeName);
                        },
                        child: RichText(
                            ...
                            children: [
                              ...
                              TextSpan(
                                ...
                                recognizer: TapGestureRecognizer()
                                  ..onTap = () async {
                                    logFirebaseEvent(
                                        'LOGIN_EMAIL_RichTextSpan_cfdma4h8_ON_TAP');
                                    logFirebaseEvent(
                                        'RichTextSpan_navigate_to');

                                    context.pushNamed(
                                        LoginEmailSignUpWidget.routeName);
                                  },
                              )
                            ],
                            style: FlutterFlowTheme.of(context)
