      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ONBOARDING3_arrow_back_ios_new_ICN_ON_TA');
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text:
                              'after vibing online, you\'ll be gently nudged to take things offline and turn your connection into a real friendship.',
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 70.0, 0.0, 12.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('ONBOARDING3_PAGE_NEXT_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');

                        context.pushNamed(Onboarding4Widget.routeName);
                      },
                      text: 'next',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ONBOARDING3_SKIP_TO_CREATE_YOUR_ACCOUNT_');
                        logFirebaseEvent('Button_navigate_to');

                        context.pushNamed(SignUp001Widget.routeName);
                      },
                      text: 'skip to create your account',
                      options: FFButtonOptions(
                        width: double.infinity,
                        height: 45.0,
                        padding: EdgeInsetsDirectional.fromSTEB(
