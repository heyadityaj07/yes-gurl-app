      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('ONBOARDING1_PAGE_Icon_06s192lh_ON_TAP');
                ...
                children: [
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text:
                              'take a 5-minute personality test to uncover what makes you, you - and who you\'re most compatible with',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ONBOARDING1_SKIP_TO_CREATE_YOUR_ACCOUNT_');
                        logFirebaseEvent('Button_navigate_to');
